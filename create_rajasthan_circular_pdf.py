...
def generate_rajasthan_circular_pdf():
    ...
    p1 = """राजस्थान सरकार - वित्त (नियम) विभाग
...
राज्य सरकार द्वारा सड़क दुर्घटना में गंभीर रूप से घायल व्यक्तियों को समय पर अस्पताल पहुँचाकर उनकी जान बचाने वाले भले व्यक्तियों (Good Samaritans) को प्रोत्साहित करने के उद्देश्य से "मुख्यमंत्री आयुष्मान जीवन रक्षा योजना" लागू की जाती है।

1. उद्देश्य एवं कार्यक्षेत्र:
यह योजना सम्पूर्ण राजस्थान राज्य में प्रभावी होगी। योजना का मुख्य उद्देश्य सड़क दुर्घटना में घायल व्यक्तियों को त्वरित चिकित्सा सहायता उपलब्ध कराकर मृत्यु दर में कमी लाना है।

2. पात्रता:
(1) राज्य की सीमा के भीतर सड़क दुर्घटना में घायल किसी भी व्यक्ति को अस्पताल पहुँचाने वाला कोई भी आम नागरिक (भला व्यक्ति) इस योजना का पात्र होगा।
...
(1) सड़क दुर्घटना में गंभीर घायल व्यक्ति को समय पर अस्पताल/आघात केंद्र पहुँचने वाले प्रत्येक भले व्यक्ति को रू0 10000/- (रुपये दस हजार मात्र) की प्रोत्साहन राशि प्रदान की जाएगी।
...
"""
    ...
    # Page 1
    page1 = doc.new_page()
    page1.insert_text((50, 50), p1, fontname="helv", fontsize=10)

    # Page 2
    page2 = doc.new_page()
    page2.insert_text((50, 50), p2, fontname="helv", fontsize=10)

    doc.save(pdf_path)
    doc.close()
    print(f"Clean PDF saved: {pdf_path}")
